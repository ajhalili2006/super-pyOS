...
if command == "help":    # this shows help message
  ...
  os.system('python3 xenlang.py ' + file)  # file must exist or an errno error gets thrown
...
os.system('python3 xencli.py') # for looping, otherwise the script ends after each command

# © 2020- @ProTechCEO (17lwinn)
# also copyright to jt nexus foundation